...
import { Network, RefreshCw, CheckCircle2, XCircle, Activity } from "lucide-react";
      ...
      <div className="border-b border-slate-800 pb-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Run automated diagnostics across hardware topology nodes.
          </p>
        </div>
        <button
        ...
        >
          ...
          {isScanning ? "Scanning Topology..." : "Run Health Audit"}
        </button>
      </div>
